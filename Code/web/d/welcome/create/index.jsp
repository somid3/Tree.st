...
<div class="main-block">
    <div class="w800 center">
        <div class="block">
            <div class="main gg_header white">Create Your Community</div>
            <div class="sub vl_text white">Get your searchable community created in less than a minute.</div>
        </div>
    </div>
</div>
...
<div id="create" class="w800 center">
        ...
        <div class="breakdowns">
            ...
            <div class="breakdown" id="path">
                <div class="desc">
                    ...
                    <div class="small smd_text dim2">This is the web address your members can go to create their accounts and log in.</div>
                </div>
                <div class="gather">

                    <span class="md_text dim">http://www.tree.st/</span>
            ...
            <div class="breakdown">
                <div class="desc">
                    ...
                    <div class="small smd_text dim2">What is the name of your community? For example "Garage Bands of San Francisco"</div>
                </div>
                <div class="gather">
                    <div class="input square"><input class="lg_input w250" name="name" maxlength="30"></div>
                    <div class="error"></div>
                </div>
            </div>
            ...
            <div class="breakdown">
                <div class="desc">
                    ...
                    <div class="small smd_text dim2">In one line, describe the purpose of your community. For instance "Musicians of San Francisco, find other artists near you and play music together."</div>
                </div>
                <div class="gather"><div class="input square"><input class="lg_input w250" name="desc" maxlength="60"></div></div>
                <div class="error"></div>
            </div>
        </div>
    </div>
    ...
    <div class="step glow4">
        ...
        <div class="header md_text white">
            <span class="md_header">Important</span>: Let's figure out your community's "qualities." Qualities will help your members
            to search for one another. Write each quality as a questions on the first line of the text boxes below, and each option
            as a new line. The examples below are for a "San Francisco Musicians" searchable community.
        </div>
        ...
        <div class="breakdowns">
            <div class="breakdown" id="q1">
                ...
                <div class="gather">
                    <div class="input square"><textarea class="quality lg_input" name="q1"></textarea></div>
                </div>
                <div class="error"></div>
            </div>
            ...
            <div class="breakdown" id="q2">
                ...
                <div class="gather">
                    <div class="input square"><textarea class="quality lg_input" name="q2"></textarea></div>
                </div>
                <div class="error"></div>
            </div>
            ...
            <div class="breakdown" id="q3">
                ...
                <div class="gather">
                    <div class="input square"><textarea class="quality lg_input" name="q3"></textarea></div>
               </div>
                <div class="error"></div>
            </div>
            ...
            <div class="breakdown" id="q4">
                ...
                <div class="gather">
                    <div class="input square"><textarea class="quality lg_input" name="q4"></textarea></div>
                </div>
                <div class="error"></div>
            </div>
            ...
            <div class="breakdown" id="q5">
                ...
                <div class="gather">
                    <div class="input square"><textarea class="quality lg_input" name="q5"></textarea></div>
                </div>
                <div class="error"></div>
            </div>
        </div>
    ...
    <a href="#" onclick="">
        <div class="start glow sp_header highlight">Create!</div>
    </a>
