...
#signin {
  ...
  border: solid 2px <%= HtmlDesign.dim2 %>;
  padding: 20px;
  width: 240px;
}
...
<div id="console">
  <div id="signin">
      <div id="signin-loading"><img src="./img/sm_loading.gif"></div>
  ...
  <div id="signup">
      <div id="signup-title" class="vl_text dim">
          <div id="signup-loading"><img src="./img/sm_loading.gif"></div>
          New to ghappy?
      </div>
      ...
      <div id="signup-content">
          ...
          <a href="#" onclick="Signup.signup(event, <%= networkId %>, '<%= networkChecksum %>');">
              <div id="signup-button" class="sm_button submit_button md_header w150">Sign up for ghappy</div>
          </a>
      </div>
  </div>
  ...
  <div id="provided-by" class="sm_text white">
      <div>Provided by</div>
      <a href="/"><img src="/d/assets/sm_logo.png"></a>
  </div>
