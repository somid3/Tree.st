...
<%
    ...
    // Notify members that recently joined a smart group
    {
        ...
        if (hourOfDay % 4 == 0)  CronServices.notifyNewNonPrivateSmartGroupMembers(EmailNotificationRateEnum.EVERY_FOUR_HOURS);
        if (hourOfDay % 8 == 0)  CronServices.notifyNewNonPrivateSmartGroupMembers(EmailNotificationRateEnum.EVERY_EIGHT_HOURS);
        if (hourOfDay % 12 == 0) CronServices.notifyNewNonPrivateSmartGroupMembers(EmailNotificationRateEnum.EVERY_TWELVE_HOURS);
    }
