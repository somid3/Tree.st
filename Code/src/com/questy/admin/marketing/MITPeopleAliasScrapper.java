...
public class MITPeopleAliasScrapper {
    ...
    public static void main (String[] args) throws IOException, InterruptedException {
        ...
        File manyMatchesDir = new File("/Users/omid/Desktop/many-matches/");

        // Reading all files
        String fileContents = null;
        Pattern pattern = Pattern.compile("query=alias(.*?)\"");
        String found = null;
        for (String file : manyMatchesDir.list()) {

            // Retrieving file contents
            fileContents = FileUtils.readFileToString(new File("/Users/omid/Desktop/many-matches/" + file), "UTF-8");
        ...
        for (String proxyHost : proxies.keySet()) {
            ...
            // Creating scrapper
            MITPeopleAliasScrapperThread.spawn(proxyHost, proxyPort, 0);
