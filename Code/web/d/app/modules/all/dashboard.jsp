...
<div id="all_members_dashboard">
        ...
        <div class="shortcuts">
            ...
            <a href="#" onclick="AMD.go(event, AllMembersDashboard.Section.BY_JOINED);"><div class="shortcut sm_text light_button" id="all_members_shortcut_joined">Joined Date</div></a>
